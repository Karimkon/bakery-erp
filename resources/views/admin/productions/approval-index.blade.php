...
<div class="container-fluid">
    ...
    <ul class="nav nav-pills mb-4">
        <li class="nav-item">
            <a href="{{ route('admin.productions.approval-index', ['status' => 'pending']) }}" 
               class="nav-link {{ $status == 'pending' ? 'active' : '' }}">
                <i class="bi bi-clock-history me-1"></i>Pending
            </a>
        </li>
        <li class="nav-item">
            <a href="{{ route('admin.productions.approval-index', ['status' => 'approved']) }}" 
               class="nav-link {{ $status == 'approved' ? 'active' : '' }}">
                <i class="bi bi-check-circle me-1"></i>Approved
            </a>
        </li>
        <li class="nav-item">
            <a href="{{ route('admin.productions.approval-index', ['status' => 'rejected']) }}" 
               class="nav-link {{ $status == 'rejected' ? 'active' : '' }}">
                <i class="bi bi-x-circle me-1"></i>Rejected
            </a>
        </li>
        <li class="nav-item">
            <a href="{{ route('admin.productions.approval-index', ['status' => 'all']) }}" 
                ...
                <table class="table table-hover align-middle">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="{{ route('admin.productions.approval-show', $production->id) }}" 
