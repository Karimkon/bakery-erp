...
<div class="d-flex justify-content-between align-items-center mb-4">
    ...
    <div>
        <a href="{{ route('admin.dispatches.financial-details', $driver->id) }}" class="btn btn-outline-primary btn-sm">
                        ...
                        <tr>
                            ...
                            <td>
                                @if($transaction->dispatch)
                                    <a href="{{ route('admin.dispatches.show', $transaction->dispatch_id) }}" 
