...
<head>
    ...
    <style>
        ...
        .btn-green { background:#198754; border:none; } .btn-green:hover{background:#157347;}
    </style>
</head>
<body>
<div class="d-flex align-items-center justify-content-center vh-100 px-3">
    <div class="login-container">
        <div class="text-center mb-4">
            <img src="{{ asset('images/chef.png') }}" alt="Chef Icon" class="login-logo mb-2">
            <h4 class="login-title">Chef Login</h4>
        </div>
        ...
        <form method="POST" action="{{ route('chef.login.submit') }}">
            ...
            <div class="d-grid"><button class="btn btn-green text-white fw-bold"><i class="bi bi-box-arrow-in-right me-1"></i> Login</button></div>
        </form>
    </div>
</div>
</body>
