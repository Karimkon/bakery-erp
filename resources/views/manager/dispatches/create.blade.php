...
<form method="POST" action="{{ route('manager.dispatches.store') }}">
    @csrf
    ...
    <p class="text-muted small">
        Opening stock shows current available bakery stock. manager cannot dispatch more than available.
    </p>
...
$(document).ready(function() {
    ...
    function stopDraw() {
        drawing = false;
        ctx.beginPath(); // reset path so new stroke starts fresh
    }
    ...
    $('#driver_id, input[name="dispatch_date"]').on('change', function(){
        ...
        let url = "{{ url('manager/dispatches/openings') }}/" + driverId + "/" + date;
