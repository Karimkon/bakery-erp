...
<head>
    ...
    <style>
        ...
        .btn-purple { background:#6f42c1; border:none; } .btn-purple:hover{background:#5a32a3;}
    </style>
</head>
<body>
<div class="d-flex align-items-center justify-content-center vh-100 px-3">
    <div class="login-container">
        <div class="text-center mb-4">
            <img src="{{ asset('images/finance.png') }}" alt="Finance Icon" class="login-logo mb-2">
        ...
        <form method="POST" action="{{ route('finance.login.submit') }}">
            ...
            <div class="d-grid"><button class="btn btn-purple text-white fw-bold"><i class="bi bi-box-arrow-in-right me-1"></i> Login</button></div>
        </form>
    </div>
</div>
</body>
